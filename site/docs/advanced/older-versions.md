...
- The default `godror` build uses a thick database client. Ensure your database client libraries are compatible with your database version. The `goora` build is available when a pure-Go client is preferred.
